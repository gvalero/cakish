...
describe("buildInquirySummary", () => {
  ...
  it("shows surcharge amount for non-zero filling", () => {
    ...
    expect(summary).toContain("Filling: Dulce de Leche (+EUR 3.00)");
  });
  ...
  it("includes finish line when hasFinishOptions is true", () => {
    ...
    expect(summary).toContain("Finish: Floral Finish (+EUR 18.00)");
  });
  ...
  it("includes topper message when provided", () => {
    ...
    expect(summary).toContain('Custom topper message: "Happy Birthday!" (+EUR 5.00)');
  });
